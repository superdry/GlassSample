...
public class LiveCardService extends Service {
    ...
    private ArrayList<Item> initItems(){
        ...
        items = addItem(items,
                ...
                139.76675399999999f);
        items = addItem(items,
                "夢に出てくるようなモーニングセット、700円＠九段下！",
                "九段下駅から少し離れ、靖国神社の前にある パン屋『FACTORY』のモーニング。  「モーニングセット 700円」を注文すると、 5種類の中から2つの種類のパンを選び、 スクランブルエッグと紅茶か珈琲が付いてくる。  …の上にさらに加え、 ゆで卵、シリアル、ヨーグルト、フルーツ、牛乳、オレンジジュース、ジャム・バターがなんとバイキング形式！ パンも天然酵母を利用しており、ビッグサイズでおいしい！！  一度は訪れないといけないベーカリーに追加◎",
                "ファクトリー　九段下",
                R.drawable.item100,
                35.693127500000003f,
                139.74351809999996f);
